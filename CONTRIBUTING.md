...
1. Make commits to your feature branch. Prefix each commit like so:
  ...
  - (test) ...
  - (doc) ...
1. When you've finished with your fix or feature, Rebase upstream changes into your branch and then submit a [pull request][]
   directly to master. Include a description of your changes.
1. Your pull request will be reviewed.
1. Fix any issues raised, and push your fixes as a single new commit.
